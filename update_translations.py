...
translations = {
    ...
    "kn": {
        "gps_disabled": "ಸ್ಥಳ ಸೇವೆಗಳನ್ನು ನಿಷ್ಕ್ರಿಯಗೊಳಿಸಲಾಗಿದೆ. ಕಾರ್ಯಗಳನ್ನು ನಿರ್ವಹಿಸಲು ದಯವಿಟ್ಟು GPS ಸಕ್ರಿಯಗೊಳಿಸಿ।",
    ...
    "mr": {
        ...
        "registered_users": "नोंदણીकृत वापरकर्ते",
        "issues_resolved": "सुटलेल्या समस्या",
        "cities": "शहरे"
    },
    "or": {
        "gps_disabled": "ଲୋକେସନ୍ ସେବା ଅକ୍ଷମ ଅଛି | କାର୍ଯ୍ୟ କରିବାକୁ ଦୟାକରି GPS ସକ୍ଷମ କରନ୍ତୁ |",
        "retry": "ବର୍ତ୍તମାନ ପୁନର୍ବାର ଚେଷ୍ଟﺎ କରନ୍ତু",
        "online_users": "ଅନଲାଇନ୍ ବ୍ୟවହାରକାରୀ",
        "registered_users": "ପଞ୍ਜੀକୃତ ବ୍ୟවହାରକারি",
        "issues_resolved": "ସମାଧାନ ହୋଇଥିବା ସମସ୍ୟା",
        "cities": "ସହରଗୁଡିକ"
    },
    "pa": {
        "gps_disabled": "ਲੋਕੇਸ਼ਨ ਸੇਵਾਵਾਂ ਅਯੋਗ ਹਨ। ਕਿਰਪਾ ਕਰਕੇ ਕਾਰਵਾਈ ਕਰਨ ਲਈ GPS ਨੂੰ ਚਾਲੂ ਕਰੋ।",
    ...
    "te": {
        ...
        "online_users": "ఆన్‌లైన వినియోగదారులు",
